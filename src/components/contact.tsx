        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              ...
              <div>
                <h4 className="text-lg font-medium text-gray-900 mb-4">Connect</h4>
            ...
            <div>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="name" className="block text-gray-900 font-medium mb-2 text-sm">
                      Name
                    </label>
                    <input
                      type="text"
                ...
                <div>
                  <label htmlFor="subject" className="block text-gray-900 font-medium mb-2 text-sm">
                    Subject
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="message" className="block text-gray-900 font-medium mb-2 text-sm">
                    Message
                  </label>
                  <textarea
                    id="message"
