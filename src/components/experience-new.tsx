  ...
  const experiences = [
    {
      ...
      period: "2023 - Present",
      description:
        "Led development of scalable web applications using React and Node.js. Implemented microservices architecture and mentored junior developers.",
    ...
    },
    {
      ...
      period: "2022 - 2023",
      description:
        "Developed and maintained multiple client-facing web applications. Optimized database queries and integrated third-party APIs.",
    ...
    },
    {
      ...
      period: "2021 - 2022",
      description:
        "Built responsive and interactive user interfaces using React. Collaborated with designers to implement pixel-perfect designs.",
